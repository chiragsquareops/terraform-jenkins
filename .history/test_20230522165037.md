...
Create Terraform code for IPV6 supported EKS, Managed-Nodes -- To create a terraform code for creation of eks cluster using public module and use terraform resources  
