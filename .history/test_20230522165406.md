...
Check status of infra from outside cluster -- Considering the scenario's create an iam-roles for Managed-Nodes to get connected to eks cluster
Via daily setup -- Test for IPv6 by deploying terraform codes everyday
