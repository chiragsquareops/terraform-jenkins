...
Create Terraform code for IPV6 supported VPC -- To create a terraform code using VPC public module for creation ofVPC                                              with IPV6 support
Create Terraform code for IPV6 supported EKS, Managed-Nodes
